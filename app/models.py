...
class Student(models.Model):
    ...
    student_status =  models.CharField(blank=True, default='inprogress', null=True, max_length=100)
    student_stream = models.CharField(blank=True, null=True, max_length=100)
